...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n   ╷\n14 │ @import 'bootstrap/scss/functions'; // Bootstrap core function\n   │         ^^^^^^^^^^^^^^^^^^^^^^^^^^\n   ╵\n  resources/js/src/@core/scss/base/bootstrap-extended/_include.scss 14:9       @import\n  resources/js/src/@core/scss/base/plugins/forms/form-quill-editor.scss 1:9    @import\n  resources/js/src/@core/scss/vue/libs/quill.scss 1:9                          @import\n  resources/js/src/views/forms/form-element/quill-editor/QuillEditor.vue 30:9  root stylesheet");
