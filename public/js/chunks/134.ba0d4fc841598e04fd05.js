...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n   ╷\n14 │ @import 'bootstrap/scss/functions'; // Bootstrap core function\n   │         ^^^^^^^^^^^^^^^^^^^^^^^^^^\n   ╵\n  resources/js/src/@core/scss/base/bootstrap-extended/_include.scss 14:9       @import\n  resources/js/src/@core/scss/base/pages/page-knowledge-base.scss 10:9         @import\n  resources/js/src/@core/scss/vue/pages/page-knowledge-base.scss 1:9           @import\n  resources/js/src/views/pages/Knowledge-base/KnowledgeBaseCategory.vue 141:9  root stylesheet");
