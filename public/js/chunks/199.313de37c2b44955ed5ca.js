        ...
        _c("table", { staticClass: "table" }, [
          _c("thead", [
            _c("tr", [
              ...
              _c("th", [_vm._v("Stock")]),
              _vm._v(" "),
              _c("th", { attrs: { scope: "col" } }, [_vm._v("ViewCount")]),
              _vm._v(" "),
              _c("th", [_vm._v("Prices")]),
              _vm._v(" "),
              _c("th", [_vm._v("Weight")]),
          ...
          _c(
            ...
            _vm._l(_vm.goods, function (c) {
              return _c("tr", { key: c.id }, [
                ...
                _c("td", [
                  _vm._v(
                    _vm._s(c.category.name) +
                      "/" +
                      _vm._s(c.category.parent_category.name)
                  ),
                ]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(c.total_stock))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(c.view_count))]),
                _vm._v(" "),
                _c(
                  "td",
                  _vm._l(_vm.good.prices, function (price) {
                    return _c("span", { key: price.id + "price" }, [
                      price.expired != null
                        ? _c("span", { staticClass: "badge bg-info" }, [
                            _vm._v(_vm._s(price.expired.ori_price)),
                          ])
                        : _c("span", { staticClass: "badge bg-info" }, [
                            _vm._v("Null"),
                          ]),
                      _vm._v("~ " + _vm._s(price.price) + " "),
                      _c("hr"),
                    ])
                  }),
                  0
                ...
                _c(
                  "td",
                  _vm._l(c.prices, function (price) {
                    return _c("span", { key: price.id + "weight" }, [
                      _c("span", { staticClass: "badge bg-info" }, [
                        _vm._v(_vm._s(price.goods_weight)),
                      ]),
                    ])
                  }),
                  0
                ...
                _c("td", [
                  _vm._v(
                    _vm._s(c.recommended_flag) + " " + _vm._s(c.onshop_flag)
                  ),
                ]),
                _vm._v(" "),
                _c(
