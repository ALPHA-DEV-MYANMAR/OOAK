...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n  ╷\n1 │ @import '~vue-context/src/sass/vue-context';\n  │         ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  ╵\n  resources/js/src/@core/scss/vue/libs/vue-context.scss 1:9            @import\n  resources/js/src/views/extensions/context-menu/ContextMenu.vue 21:9  root stylesheet");
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/var/www/html/ooak/node_modules/vue-context/src/js/index.js'");
